...
int main(void) {
  ...
  CHECK(sitl_initial_conditions_load("sitl_initial_defaults.ini", &initial, error, sizeof(error)));
  ...
  CHECK(!sitl_initial_conditions_load("sitl_initial_unknown.ini", &initial, error, sizeof(error)));

  CHECK(write_file("sitl_initial_invalid.ini", "lat_deg = nope\n"));
  CHECK(!sitl_initial_conditions_load("sitl_initial_invalid.ini", &initial, error, sizeof(error)));
