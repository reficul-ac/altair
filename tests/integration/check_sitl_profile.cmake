...
foreach(ROW_INDEX RANGE 1 ${LAST_INDEX})
    ...
    if(NOT FIELD_COUNT EQUAL 56)
        message(FATAL_ERROR "expected 56 CSV fields in ${CSV_FILE}, got ${FIELD_COUNT}: ${ROW}")
    endif()
...
list(GET FIRST_FIELDS 53 FIRST_MISSION_ACTIVE)
list(GET FIRST_FIELDS 54 FIRST_MISSION_COUNT)
list(GET LAST_FIELDS 52 LAST_MISSION_LOADED)
list(GET LAST_FIELDS 53 LAST_MISSION_ACTIVE)
list(GET LAST_FIELDS 54 LAST_MISSION_COUNT)
