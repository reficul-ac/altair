...
foreach(ROW_INDEX RANGE 1 ${LAST_INDEX})
  ...
  if(NOT FIELD_COUNT EQUAL 40)
    message(FATAL_ERROR "expected 40 CSV fields in ${CSV_FILE}, got ${FIELD_COUNT}: ${ROW}")
  endif()
  ...
  list(GET FIELDS 19 ROLL)
  list(GET FIELDS 20 PITCH)
  list(GET FIELDS 26 P_RATE)
  list(GET FIELDS 27 Q_RATE)
  list(GET FIELDS 28 R_RATE)
  list(GET FIELDS 29 AIRSPEED)
  list(GET FIELDS 30 ALTITUDE)
