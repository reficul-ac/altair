...
- Readiness currently uses decoded link freshness, GPS fix, battery remaining, mission sequence, and firmware identity. Estimator health, failsafe state, power-domain checks, firmware-specific preflight checks, and field-operation acceptance remain roadmap work.
